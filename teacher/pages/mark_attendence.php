<div class="content container-fluid">
		...
		<div class="row">
				<div class="col-sm-6">
					...
					<input type="time" class="form-control" name="in_time" value="<?php if(!empty($fetchAttendance['in_time'])){echo $fetchAttendance['in_time'];}?>">
					</div>
				</div><!-- col -->
				<div class="col-sm-6">
					<div class="form-group">
						<label for="">Out Time</label>
					<input type="time" class="form-control" name="out_time" value="<?php if(!empty($fetchAttendance['out_time'])){echo $fetchAttendance['out_time'];}?>">
					</div>
				</div><!-- col -->
			</div><!-- row -->
		<div class="text-right">
