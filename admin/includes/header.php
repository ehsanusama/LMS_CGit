...
<div class="header">
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow">
            <a href="" class="dropdown-toggle nav-link" data-toggle="dropdown">
                <span class="user-img"><img class="rounded-circle" src="../uploads/default.png" width="31" alt="admin"></span>
            </a>
            <div class="dropdown-menu">
                <div class="user-header">
                    <div class="avatar avatar-sm">
                        <img src="../uploads/default.png" alt="Admin" class="avatar-img rounded-circle">
                    </div>

                    <div class="user-text">
                        <h6><?= $data['admin_fname']; ?></h6>
...
?>
        <script>
            setTimeout(function() {
                window.location.href = "../index.php?login_user=admin";
            });
        </script>
<?php
    }
