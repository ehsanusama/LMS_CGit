...
<div class="header">
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow">
            <a href="" class="dropdown-toggle nav-link" data-toggle="dropdown">
                <span class="user-img"><img class="rounded-circle" src="../uploads/<?= $data['student_pic'] ?>" width="31" alt="Ryan Taylor"></span>
            </a>
            <div class="dropdown-menu">
                <div class="user-header">
                    <div class="avatar avatar-sm">
                        <img src="../uploads/<?= $data['student_pic'] ?>" alt="User Image" class="avatar-img rounded-circle">
                    </div>

                    <div class="user-text">
                        <h6><?= $data['student_fname']; ?> <?= $data['student_lname']; ?></h6>
...
?>
        <script>
            setTimeout(function() {
                window.location.href = "../index.php?login_user=student";
            });
        </script>
<?php
    }
